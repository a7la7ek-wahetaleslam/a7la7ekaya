    ...
    function toggleQuranLibrary() {
        var forumWrapper = document.getElementById('forum-main-wrapper');
    ...
    const targetSurahs = [
        { id: '001', ar: 'الفاتحة', en: 'Al-Fatihah' },
        { id: '002', ar: 'البقرة', en: 'Al-Baqarah' },
        { id: '003', ar: 'آل عمران', en: 'Aal-E-Imran' },
        { id: '012', ar: 'يوسف', en: 'Yusuf' },
        { id: '018', ar: 'الكهف', en: 'Al-Kahf' },
        { id: '019', ar: 'مريم', en: 'Maryam' },
        { id: '021', ar: 'الأنبياء', en: 'Al-Anbiya' },
        { id: '025', ar: 'الفرقان', en: 'Al-Furqan' },
        { id: '036', ar: 'يس', en: 'Yaseen' },
        { id: '055', ar: 'الرحمن', en: 'Ar-Rahman' },
        { id: '067', ar: 'الملك', en: 'Al-Mulk' },
        { id: '072', ar: 'الجن', en: 'Al-Jinn' },
    ...
    function initSearchData() {
        ...
        adhkarAndDuas.forEach(item => {
            allSearchTracks.push({
                ...
                ar: item.ar,
                en: item.en,
                reciterAr: 'مكتبة واحة الإسلام',
                reciterEn: 'Wahet Al-Eslam',
    ...
    searchInput.addEventListener('input', function() {
        ...
        if (query === '') {
            ...
            if (lastActiveView === 'home') homeView.style.display = 'block';
            else surahsView.style.display = 'block';
            return;
        }
        ...
        if (matchedReciters.length === 0 && matchedTracks.length === 0) {
            tGrid.innerHTML = `<div style="grid-column: 1/-1; text-align:center; padding: 30px; color: var(--text-muted); font-weight: bold; font-size: 18px;">لا توجد نتائج مطابقة لـ "${query}"</div>`;
        }
    });
    ...
    document.getElementById('langToggle').addEventListener('click', () => {
        ...
        if (headerTitle.dataset.reciterAr) headerTitle.textContent = headerTitle.getAttribute(`data-reciter-${currentLang}`);
    ...
    (function() {
        function checkRights() {
            ...
            if (!rightsWrapper || !devLink || 
                devLink.getAttribute('href') !== 'https://www.facebook.com/Flying1free' ||
